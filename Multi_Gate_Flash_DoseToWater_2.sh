...
Name_Of_File=runs_Dose_DoseToWater # Mettre le nom du dossier de sauvegarde des données ~ nom du dossier de l'étude
...
Actor_1_Name=dose
Actor_1_Save=output/dose-proton.root

Actor_1_attachTo=frite

Actor_1_setResolution="2 500 500" ### /!\ 1e8 bin = 8.5 Go of RAM || 1e9 -> > 20 Go
