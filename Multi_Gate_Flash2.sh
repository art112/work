...
Name_Of_File=runs_Potentiel_Ioni # Mettre le nom du dossier de sauvegarde des données ~ nom du dossier de l'étude
...
Target_Material=Water # G4_WATER

SetCutCuve=0.1

#/gate/geometry/setIonisationPotential Water 78 eV

IonisationPotential_Water=75
...
echo "IonisationPotential_Water = ${IonisationPotential_Water}"
...
/gate/geometry/setIonisationPotential ${Target_Material} ${IonisationPotential_Water} eV
