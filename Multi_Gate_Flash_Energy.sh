...
Name_Of_File=runs_Test_Energy # Mettre le nom du dossier de sauvegarde des données ~ nom du dossier de l'étude
...
Frite_Lenght_Unit=${Target_Lenght_Unit}
Frite_XLength=${Target_XLength}
Frite_YLength=${Target_YLength}

Frite_ZLength=0 # Defini automatiquement
...
LongueurDeLaCible_L="${Target_ZLength}"
LongeurDeLaFrite_lF="0.01" ### Meme unite que target Z lenght


NombreDeFrite=$(echo "$LongueurDeLaCible_L / $LongeurDeLaFrite_lF"  |bc -l )
NombreDeFrite=$(echo $((${NombreDeFrite%.*} + 0))) ##" arrondi supérieur -> +1


#NombreDeFrite=10 ## Nombre entier !!! 
...
echo "NombreDeFrite ${NombreDeFrite}"
echo "LongueurDeLaCible_L ${LongueurDeLaCible_L}"
echo "LongeurDeLaFrite_lF ${LongeurDeLaFrite_lF}"
echo " "
echo "***Setup***"
echo " "
...
echo "Script Multi_Part"



#for((energy_i=${ENERGY_MIN} ; energy_i<${ENERGY_MAX} ; energy_i+=${PAS_ENERGY}))

for((Setup_Frite_i=0 ; Setup_Frite_i < ${NombreDeFrite} ; Setup_Frite_i+=${PasFrite}))
do


NameFrite="Frite_${Setup_Frite_i}"
echo "NameFrite ${NameFrite}"

Frite_Placement_Calcul_Z=`echo "-$LongueurDeLaCible_L/2 + ($LongeurDeLaFrite_lF)*(0.5+$Setup_Frite_i)" |bc -l`

echo "Frite_Placement_Calcul_Z ${Frite_Placement_Calcul_Z}"

#echo "${Frite_Placement_Calcul_Z}" | python -c "print round(float(raw_input()))"

Frite_Placement="0. 0. ${Frite_Placement_Calcul_Z} ${Frite_Lenght_Unit}"

echo "Frite_Placement ${Frite_Placement}"


/bin/cat <<EOM >> ${WORK_DIR}/run_launcher.mac


/gate/cuve/daughters/name ${NameFrite}
/gate/cuve/daughters/insert box
/gate/${NameFrite}/setMaterial ${Frite_Material}
/gate/${NameFrite}/geometry/setXLength ${Frite_XLength} ${Frite_Lenght_Unit}
/gate/${NameFrite}/geometry/setYLength ${Frite_YLength} ${Frite_Lenght_Unit}
/gate/${NameFrite}/geometry/setZLength ${LongeurDeLaFrite_lF} ${Frite_Lenght_Unit}
/gate/${NameFrite}/placement/setTranslation ${Frite_Placement}
/gate/${NameFrite}/vis/setColor magenta
#/gate/${NameFrite}/vis/forceSolid
...
/gate/actor/addActor PhaseSpaceActor               ${NameFrite}_phasespaceactor
/gate/actor/${NameFrite}_phasespaceactor/save                     output/${NameFrite}_PhaseSpace.root
/gate/actor/${NameFrite}_phasespaceactor/attachTo                 ${NameFrite}
/gate/actor/${NameFrite}_phasespaceactor/enableProductionProcess  false

/gate/actor/${NameFrite}_phasespaceactor/enableEkine              true
/gate/actor/${NameFrite}_phasespaceactor/enableXPosition          true
/gate/actor/${NameFrite}_phasespaceactor/enableYPosition          true
/gate/actor/${NameFrite}_phasespaceactor/enableZPosition          true
/gate/actor/${NameFrite}_phasespaceactor/enableXDirection         false
/gate/actor/${NameFrite}_phasespaceactor/enableYDirection         false
/gate/actor/${NameFrite}_phasespaceactor/enableZDirection         false
/gate/actor/${NameFrite}_phasespaceactor/enableProductionVolume   true
/gate/actor/${NameFrite}_phasespaceactor/enableProductionProcess  true
/gate/actor/${NameFrite}_phasespaceactor/enableParticleName       true
/gate/actor/${NameFrite}_phasespaceactor/enableWeight             false

/gate/actor/${NameFrite}_phasespaceactor/addFilter                       particleFilter
/gate/actor/${NameFrite}_phasespaceactor/particleFilter/addParticle      proton
