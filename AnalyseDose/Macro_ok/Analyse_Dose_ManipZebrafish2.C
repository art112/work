...
return TempsGraph;
 ...
 void Analyse_Dose_ManipZebrafish2(){
     ...
     else PathFile = "/media/sf_PartageVbox8/Results/"+Projet +"/";
...
//    leg->SetFillStyle(1001);
    ...
    // Scale coef 
     ...
     for(auto& x: map_Histo_Ref){
         ...
         if(WichCase.Contains("_0.68_")) { 
             Scale_Coef = (4.419118914 * 1.0137e10) / 1e6;
         }
         if(WichCase.Contains("_1_")) Scale_Coef = (4.408121523* 1.0137e10) / 1e6;
         if(WichCase.Contains("_0_"))Scale_Coef = (4.397653412 * 1.0137e10) / 1e6;
