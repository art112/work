 ...
 TGraphErrors * TGraphConstruct_SerieA(){
     ...
     map_Data_XP_Serie_A[7.3]=1.04480596817935;
     map_Data_XP_Serie_A[10.3]=1.0867979622305;
     map_Data_XP_Serie_A[13.3]=1.13952808124461;
     map_Data_XP_Serie_A[16.3]=1.19936991772975;
     map_Data_XP_Serie_A[18.3]=1.24816949604425;
     map_Data_XP_Serie_A[20.3]=1.30294299339029;
     map_Data_XP_Serie_A[22.3]=1.36961929600223;
     map_Data_XP_Serie_A[24.3]=1.44857415446147;
     map_Data_XP_Serie_A[26.3]=1.54972865361478;
     map_Data_XP_Serie_A[27.3]=1.61031036787777;
     map_Data_XP_Serie_A[28.3]=1.68271160935793;
     map_Data_XP_Serie_A[29.3]=1.76585389227295;
     map_Data_XP_Serie_A[30.3]=1.86513466700163;
     map_Data_XP_Serie_A[31.3]=1.99478402825936;
     map_Data_XP_Serie_A[32.3]=2.15254360301118;
     map_Data_XP_Serie_A[32.8]=2.25185618290549;
     map_Data_XP_Serie_A[33.3]=2.37200515994155;
     map_Data_XP_Serie_A[33.8]=2.51710794917888;
     map_Data_XP_Serie_A[34.3]=2.70300410035815;
     map_Data_XP_Serie_A[34.55]=2.81752835299214;
     map_Data_XP_Serie_A[34.8]=2.94630196998581;
     map_Data_XP_Serie_A[35.05]=3.09926598270443;
     map_Data_XP_Serie_A[35.3]=3.28591450595655;
     map_Data_XP_Serie_A[35.4]=3.37491240364401;
     map_Data_XP_Serie_A[35.6]=3.58485641626284;
     map_Data_XP_Serie_A[35.8]=3.84447958950786;
     map_Data_XP_Serie_A[35.95]=4.06591193975345;
     map_Data_XP_Serie_A[36.05]=4.25579200570136;
     map_Data_XP_Serie_A[36.2]=4.5046419856168;
     map_Data_XP_Serie_A[36.3]=4.69218107718132;
     map_Data_XP_Serie_A[36.45]=4.88644916815905;
     map_Data_XP_Serie_A[36.55]=5.00560616678346;
     map_Data_XP_Serie_A[36.65]=5.04601016274853;
     map_Data_XP_Serie_A[36.8]=4.9979885849895;
     map_Data_XP_Serie_A[36.95]=4.78384173633608;
     map_Data_XP_Serie_A[37.05]=4.52908199018921;
     map_Data_XP_Serie_A[37.2]=4.07522414783651;
     map_Data_XP_Serie_A[37.3]=3.66504615947107;
     map_Data_XP_Serie_A[37.45]=3.07247298075242;
     map_Data_XP_Serie_A[37.55]=2.683502988619;
     map_Data_XP_Serie_A[37.7]=2.08875390712509;
     map_Data_XP_Serie_A[37.8]=1.66382712235603;
     map_Data_XP_Serie_A[38.05]=0.944778882772831;
     map_Data_XP_Serie_A[38.3]=0.447823808881107;
     map_Data_XP_Serie_A[38.8]=0.0499090022582924;
     map_Data_XP_Serie_A[39.8]=0;
 ...
 void Analyse_Dose_ManipZebrafish_Stack_Projet_ROOS_config2(){
     ...
     TLegend * leg2 = new TLegend(0.2036718,0.6203156,0.4784854,0.8392505,NULL,"brNDC");
...
//      leg->SetTextAlign(22);
     ...
     if(Farm == true){
         ...
         vec_Option.clear();
         NameSetup="vROOS_v6_Ligne_Seule_CI_Config2_v1_Stack_Manip_13_08_20_config2";
//          CompleteNameSetup= NameSetup +"_68MeV_0" ; vec_Option.push_back(CompleteNameSetup);
...
//          CompleteNameSetup= NameSetup +"_68MeV_1" ; vec_Option.push_back(CompleteNameSetup);
         ...
         CompleteNameSetup= NameSetup +"_68MeV_0.40" ; vec_Option.push_back(CompleteNameSetup);
         
         vec_Option.clear();
         NameSetup="vROOS_v8_Ligne_Seule_CI_Config2_v1_Stack_Manip_13_08_20_config2";
         CompleteNameSetup= NameSetup +"_68MeV_0" ; vec_Option.push_back(CompleteNameSetup);
...
//          const_ICO->LoadSetup_with_RunSystem_GateLog(map_Comment_Ref, totalPathReadInformation.Data(), i_Setup ,0);
     ...
     leg2->AddEntry(TGraph_Data, "13/08/20 Config2", "lpe");
