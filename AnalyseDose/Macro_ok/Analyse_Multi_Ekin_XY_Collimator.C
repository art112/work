...
//      cout << "Max_Projection " << Max_Projection << " BinMin_Projection " << BinMin_Projection << " BinMax_Projection " << BinMax_Projection << " RangeMin " << RangeMin << " RangeMax " << RangeMax<< endl;
 ...
 void Analyse_Multi_Ekin_XY_Collimator(){
     ...
     ///****** *********** ************//
     string Projet = "z_Projet_Collimateur";
     string NameSetup = "";
     ...
     if(Farm == true){
         ...
         vec_Option.clear();
         NameSetup="vMZfv2_Ligne_ICO_v2T_colli";
...
//           }
//      //      
     std::vector<string> vec_Other {"Colli2","Colli4", "Colli4Ext", "Ref_RA", "Colli2_RA"};
...
//                      if(i_hgr==0){ h_d_Clone->GetXaxis()->SetRangeUser(map_Result_Fit[i_hgr]["Mean"]-3*map_Result_Fit[i_hgr]["Sigma"],map_Result_Fit[i_hgr]["Mean"]+3*map_Result_Fit[i_hgr]["Sigma"]);}
