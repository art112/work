...
PathFile="/home/gate/nantes_sps/abongran/All_Results/z_Projet_Collimateur/9.0/"
...
option=("vMZfv2_Ligne_ICO_v2T_colli_68MeV_0_" "vMZfv2_Ligne_ICO_v2T_colli_68MeV_0.68_" "vMZfv2_Ligne_ICO_v2T_colli_68MeV_1_") 
...
len3=${#option[@]}  # nombre d'éléments dans le tableau
 ...
 #std::vector<string> Category_Of_Analyse {"Epaisseur", "Pos"};
 z=(Colli2 Colli4 Colli4Ext Colli2_RA)  # initialisation du tableau

# z=(Colli2_RA)  # initialisation du tableau
...
#  root -l -q "Analyse_CaracterisationDuSetup_Collimator.C(\"${PathFile_Total}\")"
 ...
 PathFile_Total="${PathFile}output_Ref_RA_${option[o]}${Coef_Event}${Unit_Event}/"
root -l -q "Analyse_CaracterisationDuSetup_Collimator.C(\"${PathFile_Total}\")" 
