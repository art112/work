 ...
 void Analyse_CaracterisationDuSetup_z_Projet_Zebrafish(const char* PathFile_CS = "/home/gate/nantes_sps/abongran/All_Results/z_Projet_Manip_ZebraFish_11_03_20/9.0/output_Ref_Cube_G4_PLEXIGLASS_vMZfv2_0.1_Manip_ZebraFish_110320_v1_68MeV_0.68_1M/" ){
     ...
     string extension_txt = ".txt";
      ...
      std::vector<string> vec_Name_PhaseSpace {"frite_kapton_phasespaceactor", "frite_Kapton_after_phasespaceactor", "frite_colli_before_phasespaceactor", "frite_colli_after_phasespaceactor", "frite_colli_after_phasespaceactor2","frite_Lightdetector_before_phasespaceactor", "frite_Lightdetector_after_phasespaceactor","frite_Ionizationchamber_before_phasespaceactor", "frite_Ionizationchamber_after_phasespaceactor",  "frite_colli2_before_phasespaceactor" ,"frite_colli2_after_phasespaceactor","frite_colli2_after_phasespaceactor2"}; 
...
//      hZ->Fill(0);
     ...
     if(Analyse_principal == true){
         ...
         for(auto& NamePhaseSpace: vec_Name_PhaseSpace){
             ...
             if(NamePhaseSpace == "frite_colli2_after_phasespaceactor2" ){
                 string Replace_NamePhaseSpace = "frite_colli2_after_phasespaceactor";
                 CompletePath = PathFile + Replace_NamePhaseSpace + extension;
                 RealNameSpace = Replace_NamePhaseSpace;
             }
             ...
             if(Relecture==true){
                 ...
                 for(auto& Name_CutOrder: vec_Name_CutOrder){
                     ...
                     if(NamePhaseSpace == "frite_colli_after_phasespaceactor2" )Cut_Order += "&&X<50&&X>-50&&Y<50&&Y>-50";
                      if(NamePhaseSpace == "frite_colli2_after_phasespaceactor2" )Cut_Order += "&&X<50&&X>-50&&Y<50&&Y>-50";
                 ...
                 while ( myReader.Next()) {
                     ...
                     if(NamePhaseSpace == "frite_colli_after_phasespaceactor2" || NamePhaseSpace == "frite_colli2_after_phasespaceactor2" ){
