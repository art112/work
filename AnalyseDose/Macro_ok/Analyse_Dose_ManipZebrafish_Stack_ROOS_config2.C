 ...
 TGraphErrors * TGraphConstruct_SerieA(){
     ...
     map_Data_XP_Serie_A[-23.7]=1.26957295373665;
     map_Data_XP_Serie_A[-20.7]=1.32645739910314;
     map_Data_XP_Serie_A[-17.7]=1.37976929902396;
     map_Data_XP_Serie_A[-14.7]=1.44671403197158;
     map_Data_XP_Serie_A[-11.7]=1.52268760907504;
     map_Data_XP_Serie_A[-9.7]=1.58464223385689;
     map_Data_XP_Serie_A[-7.7]=1.65418118466899;
     map_Data_XP_Serie_A[-5.7]=1.73883161512027;
     map_Data_XP_Serie_A[-3.7]=1.83907056798623;
     map_Data_XP_Serie_A[-1.7]=1.96749358426005;
     map_Data_XP_Serie_A[-0.7]=2.04440649017933;
     map_Data_XP_Serie_A[0.3]=2.13632514817951;
     map_Data_XP_Serie_A[1.3]=2.24188034188034;
     map_Data_XP_Serie_A[2.3]=2.36792452830189;
     map_Data_XP_Serie_A[3.3]=2.53252385082394;
     map_Data_XP_Serie_A[4.3]=2.73281114012185;
     map_Data_XP_Serie_A[4.8]=2.85889570552147;
     map_Data_XP_Serie_A[5.3]=3.01143359718558;
     map_Data_XP_Serie_A[5.8]=3.19565217391304;
     map_Data_XP_Serie_A[6.3]=3.43166089965398;
     map_Data_XP_Serie_A[6.55]=3.57705779334501;
     map_Data_XP_Serie_A[6.8]=3.740545294635;
     map_Data_XP_Serie_A[7.05]=3.9347442680776;
     map_Data_XP_Serie_A[7.3]=4.17170818505338;
     map_Data_XP_Serie_A[7.4]=4.2846975088968;
     map_Data_XP_Serie_A[7.6]=4.55123674911661;
     map_Data_XP_Serie_A[7.8]=4.88084730803177;
     map_Data_XP_Serie_A[7.95]=5.16197183098592;
     map_Data_XP_Serie_A[8.05]=5.40303842716711;
     map_Data_XP_Serie_A[8.2]=5.71897163120567;
     map_Data_XP_Serie_A[8.3]=5.95706618962433;
     map_Data_XP_Serie_A[8.45]=6.2037037037037;
     map_Data_XP_Serie_A[8.55]=6.35498220640569;
     map_Data_XP_Serie_A[8.65]=6.40627802690583;
     map_Data_XP_Serie_A[8.8]=6.3453111305872;
     map_Data_XP_Serie_A[8.95]=6.07343608340889;
     map_Data_XP_Serie_A[9.05]=5.75;
     map_Data_XP_Serie_A[9.2]=5.17379435850773;
     map_Data_XP_Serie_A[9.3]=4.65304347826087;
     map_Data_XP_Serie_A[9.45]=3.90072859744991;
     map_Data_XP_Serie_A[9.55]=3.40690281562216;
     map_Data_XP_Serie_A[9.7]=2.65182546749777;
     map_Data_XP_Serie_A[9.8]=2.11234991423671;
     map_Data_XP_Serie_A[10.05]=1.19946571682992;
     map_Data_XP_Serie_A[10.3]=0.568544995794786;
     map_Data_XP_Serie_A[10.8]=0.0633631194151097;
     map_Data_XP_Serie_A[11.8]=0;
...
//      
 ...
 void Analyse_Dose_ManipZebrafish_Stack_ROOS_config2(){
     ...
     if(Farm == true){
         ...
         vec_Option.clear();
         NameSetup="Cube_G4_WATER_vROOS_v1_0.1_SV10_Ligne_Seule_CI_Config2_v1_Stack_Manip_13_08_20_config2";
         CompleteNameSetup= NameSetup +"_68MeV_0_" ; vec_Option.push_back(CompleteNameSetup);
         CompleteNameSetup= NameSetup +"_68MeV_0.68_" ; vec_Option.push_back(CompleteNameSetup);
         CompleteNameSetup= NameSetup +"_68MeV_1_" ; vec_Option.push_back(CompleteNameSetup);
         
         vec_Option.clear();
         NameSetup="Cube_G4_WATER_vROOS_v1_0.1_SV12_Ligne_Seule_CI_Config2_v1_Stack_Manip_13_08_20_config2";
         CompleteNameSetup= NameSetup +"_68MeV_0_" ; vec_Option.push_back(CompleteNameSetup);
         CompleteNameSetup= NameSetup +"_68MeV_0.68_" ; vec_Option.push_back(CompleteNameSetup);
         CompleteNameSetup= NameSetup +"_68MeV_1_" ; vec_Option.push_back(CompleteNameSetup);
...
//      multi_general->Add(gr_Serie2,"eP");
     ...
     TString Title = "Proton range in function of beam energy for different material config 2";
