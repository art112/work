 ...
 void Analyse_CaracterisationDuSetup_CompensatorDesignAndPatientSetup(const char* PathFile_CS = "/home/gate/nantes_sps/abongran/All_Results/z_Projet_Arronax_Compensator_design/9.0/output_Ref_vACDv4.3_Ligne_ICO_v2WT_BIC_G4_WATER_68MeV_0_1M/" ){
     
     //      output_Ref_vACDv4.3_Ligne_ICO_v2T_68MeV_0.68_10M/
...
//      hZ = new TH1F("hZ","Histogram title;;Y Axis",100,0,1);
//      hZ->Fill(0);
         ...
         for(auto& NamePhaseSpace: vec_Name_PhaseSpace){
             ...
             for(auto& Name_CutOrder: vec_Name_CutOrder){
                 ...
                 if(map_Comment_Ref[i_Setup][Open_Condition1]== "true" && map_Comment_Ref[i_Setup][Open_Condition2]== "true" ){
                     ...
                     cout << "map_Comment_Ref[i_Setup][Open_Condition1]== true "  << endl;
...
//                if (gDirectory->FindObject(hZ)){if(hZ->GetEntries()<2) delete hZ;}
     ...
     bool NTUPLE_Command_1 = false;
     
     
     if(NTUPLE_Command_1==true){
