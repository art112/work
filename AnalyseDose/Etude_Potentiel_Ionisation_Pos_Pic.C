...
void Etude_Potentiel_Ionisation_Pos_Pic(){
    ...
    std::map<TString, std::map< int , std::map< float ,int > >> map_MATERIAL_IONI_E ; // Material Ionisation Energie
    ...
    for (auto& id: vec_RunConfig_ok){
        ...
        int IonisationPotential_Water = ToInteger(map_LoadedMultiSetup[ID_Setup]["IonisationPotential_Water"].Data());
        float ENERGY_ft =  ToDouble(map_LoadedMultiSetup[ID_Setup]["ENERGY"].Data());
        
        map_MATERIAL_IONI_E[MATERIAL][IonisationPotential_Water][ENERGY_ft]=ID_Setup;
        cout << "id " << id << " MATERIAL " << MATERIAL << " IonisationPotential_Water " << IonisationPotential_Water << " ENERGY_ft " << ENERGY_ft << endl;
    }
    ...
    std::map<TString, std::map< int ,TGraphErrors* >> map_StockageGraphForMulti;
    std::map<TString,std::map<int,TH1D*>> map_StockageTH1DForMulti;
    ...
    for (auto& Material_i: map_MATERIAL_IONI_E){
        ...
        for (auto& Ionisation_i: Material_i.second){
            ...
            NameHisto_temps = "hDiff_E_"+ Material_i.first + constants->IntToString(Ionisation_i.first,0);
    ...
    for (auto& Material_i: map_StockageGraphForMulti){
        ...
        for (auto& Ionisation_i: Material_i.second){
            ...
            int Ionisation_ST = Ionisation_i.first;
            ...
            TString NameHisto_temps = "";
            NameHisto_temps =  Material_i.first +" "+ constants->IntToString(Ionisation_i.first,0) + " eV";
